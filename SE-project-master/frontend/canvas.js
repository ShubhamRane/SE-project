...
document.getElementById('predict').addEventListener('click', function(e) {
    ...
    //             var canvas = document.getElementById("canvas");
    //             var dataURL = canvas.toDataURL("image/png").replace(/^data:image\/[^;]/, 'data:application/octet-stream');  // here is the most important part because if you dont replace you will get a DOM 18 exception.
              


             
    //             document.getElementById('hidden_data').value = "C:\Users\Personal\Downloads\draw.png";
    //             var fd = new FormData(document.forms["form1"]);
 
 			// 	document.getElementById('DownloadButton').click();
    //             var xhr = new XMLHttpRequest();
    //             xhr.open('POST', '../pred.php', true);
